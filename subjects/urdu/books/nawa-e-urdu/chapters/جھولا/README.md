...
This page contains chapter-wise learning resources for **Chapter 1: جھولا** from **Book 1: Nawa-e-urdu** under **Class 10 Urdu**. This chapter spans starts on page 5 · ends on page 16 · 12 pages.
...
Add one practical study tip for students preparing chapter 1: جھولا.
...
- [Next chapter: Chapter 2: نیا قانون](../نیا-قانون/README.md)
</div>

## Learn with Edzy

Need step-by-step explanations and interactive doubt solving for chapter 1: جھولا?
