...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      <SEO
        title="CBSE Class 10 AI Study Prompts"
        description="Free chapter-wise AI prompts for CBSE Class 10 across Mathematics, Science, English, Social Science, Hindi and more. Use with ChatGPT, Gemini, or Claude to study smarter and score better."
      />
      <Navbar />
          ...
          <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-10 items-start">
            ...
            <div>
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight tracking-tight mb-3">
                CBSE Class 10<br />Most Effective<br/>
